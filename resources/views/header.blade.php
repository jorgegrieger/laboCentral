...
<head>
    ...
    <meta name="description" content="LabCentral - Jorge Grieger">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="apple-touch-icon" href="{{asset('app-assets/images/favicon.png')}}">
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="{{route('recebimento.index')}}"><i class="menu-icon fa fa-truck"></i>Recebimento Matéria Prima</a>
                    </li>
                    ...
                    <li>
                        ...
                        <a href="{{route('relatorio.index')}}"> <i class="menu-icon fa fa-file-text-o"></i>Relatórios</a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
