					...
					<div class="card-body">
                            ...
                            <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="produtobo" value="{{$produto->produtobo}}">
                                    </div>
									</div>
                                    </div>
                            <div class="row">
                            <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nometec" value="{{$produto->nometec}}">
                                    </div>
									</div>
                                    </div>
                            <div class="row">
							...
							<input type="text" class="form-control" name="resparea" value="{{$produto->resparea}}">
            				</div>
							</div>
                            </div>
                            <div class="row">
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="cosap" value="{{$produto->cosap}}">
                                    </div>
									</div>
                                    </div>
                                <div class="row">
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="st" value="{{$produto->st}}">
                                    </div>
									</div>
                                    </div>
